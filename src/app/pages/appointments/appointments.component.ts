...
export class AppointmentsComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ['id', 'Current Datetime', 'Scheduled Datetime', 'Topic', 'Meeting Link', 'Owner Id' , 'Consultant Id'];
  ...
  addAppointment(): void {
    const newAppointment = {currentDatetime: this.appointmentData.currentDatetime, scheduledDatetime: this.appointmentData.scheduledDatetime, topic: this.appointmentData.topic, meetingLink: this.appointmentData.meetingLink, ownerId: this.appointmentData.ownerId, consultantId: this.appointmentData.consultantId };
